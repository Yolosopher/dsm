...
reviewfirstname.addEventListener('change', () => {
	nameChecker(reviewfirstname, true, 2)
})
reviewlastname.addEventListener('change', () => {
	nameChecker(reviewlastname, true, 2)
})
reviewform.addEventListener('submit', (e) => {
	if (
		...
		nameChecker(reviewfirstname, true, 2)
		nameChecker(reviewlastname, true, 2)
		if (reviewform.querySelectorAll('.invalid')[0]) {
			e.preventDefault()
			reviewform.querySelectorAll('.invalid').forEach((each) => {
